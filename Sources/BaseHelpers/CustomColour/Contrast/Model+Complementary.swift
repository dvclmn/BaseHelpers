...
/// ```
/// let originalColor = HSVColour(hue: 0.1, saturation: 0.8, brightness: 0.9, alpha: 1.0)
///
/// // Basic complementary
/// let complement = originalColor.complementary
///
/// // Partial complement (50% toward complementary)
/// let softComplement = originalColor.complementary(strength: 0.5)
///
/// // Using with RGB
/// let rgbColor = RGBColour(red: 0.8, green: 0.2, blue: 0.3, alpha: 1.0)
/// let rgbComplement = rgbColor.complementary
///
/// // Color harmonies
/// let analogousColors = originalColor.analogous()
/// let triadicColors = originalColor.triadic
/// let splitComplementaryColors = originalColor.splitComplementary
/// ```
...
extension HSVColour {
  ...
  public func complementary(using adjustment: HSVAdjustment, strength: Double = 1.0) -> HSVColour {
  ...
  public func analogous(count: Int = 2, spacing: Double = 30) -> [HSVColour] {
