...
import SwiftUI
//
//public struct PointerHoverModifier<Space: CoordinateSpaceProtocol>: ViewModifier {
...
//      content
//        .onContinuousHover(coordinateSpace: coordinateSpace) { hoverPhase in
...
//}
//
//extension PointerHoverModifier {
