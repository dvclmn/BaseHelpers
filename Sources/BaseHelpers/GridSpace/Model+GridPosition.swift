...
public struct GridPosition: Equatable, Hashable, Sendable, Codable {
  ...
  public mutating func offsetting(by delta: GridPosition) {
    let current = self
    self = current + delta
    //    GridPosition(row: row + delta.row, column: column + delta.column)
  }
...
//  public func offsetting(_ direction: Direction, by delta: Int = 1) -> GridPosition {
//    let (newCol, newRow) = direction.offset(x: column, y: row, by: delta)
//    return GridPosition(row: newRow, column: newCol)
//  }

  /// Symmetric offset helpers
  //  func offsettingSymmetrically(x deltaX: Int, y deltaY: Int) -> GridPosition {
  //    offsetting(
  //      row: deltaY / 2,
  //      col: deltaX / 2
  //    )
  //  }
  /// Asymmetric offset helpers
  //  func offsettingAsymmetrically(x deltaX: Int, y deltaY: Int) -> GridPosition {
  //    offsetting(row: deltaY, col: deltaX)
  //  }
  /// Directional helpers
  //  public func offsetUp(_ delta: Int) -> GridPosition {
  //    offsetBy(row: -delta, col: 0)
  //  }
  //
  //  public func offsetDown(_ delta: Int) -> GridPosition {
  //    offsetBy(row: delta, col: 0)
  //  }
  //
  //  public func offsetLeft(_ delta: Int) -> GridPosition {
  //    offsetBy(row: 0, col: -delta)
  //  }
  //
  //  public func offsetRight(_ delta: Int) -> GridPosition {
  //    offsetBy(row: 0, col: delta)
  //  }

  //  public mutating func offsetting(_ direction: Direction, by delta: Int) {
  //    var current = self
  //
  //  }

  //  public mutating func offsettingUp(_ delta: Int) -> GridPosition {
  //    offsetBy(row: -delta, col: 0)
  //  }
  //
  //  public mutating func offsettingDown(_ delta: Int) -> GridPosition {
  //    offsetBy(row: delta, col: 0)
  //  }
  //
  //  public mutating func offsettingLeft(_ delta: Int) -> GridPosition {
  //    offsetBy(row: 0, col: -delta)
  //  }
  //
  //  public mutating func offsettingRight(_ delta: Int) -> GridPosition {
  //    offsetBy(row: 0, col: delta)
  //  }
}
