...
struct SingleAnimationView: View {
    ...
    var body: some View {
        ...
        var animation: Animation {
            ...
            case .spring:
                return .spring(response: animationItem.duration ?? 0.5, dampingFraction: animationItem.bounce ?? 0.5)
            case .interpolatingSpring:
                return .interpolatingSpring(mass: animationItem.mass ?? 1.0, stiffness: animationItem.stiffness ?? 100, damping: animationItem.damping ?? 10)
            case .easeOut:
