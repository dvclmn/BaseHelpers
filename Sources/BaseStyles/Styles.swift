...
public extension Double {
    ...
    var bump: Double {
        let nextFib = self * 1.618 /// Approximate next Fibonacci number
...
public struct Styles {
    ...
    public static let toolbarLargePaddingX:                       Double = 18
    public static let toolbarPrimaryPaddingX:                       Double = 14
