...
extension GridPosition: DisplayPair {
  ...
  public var labelA: PropertyLabel { .init("C", "Column") }
  public var labelB: PropertyLabel { .init("R", "Row") }
}
extension GridDimensions: DisplayPair {
  public var valueA: Double { Double(columns) }
  public var valueB: Double { Double(rows) }
  public var labelA: PropertyLabel { .init("C", "Columns") }
  public var labelB: PropertyLabel { .init("R", "Rows") }
}
